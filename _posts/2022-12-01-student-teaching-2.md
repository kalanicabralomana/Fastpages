...
categories: [jupyter]
nb_path: _notebooks/20220-11-29-student-teaching-2.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/20220-11-29-student-teaching-2.ipynb
-->
...
<span class="c1"># it will print 20.4</span>
</pre></div>
...
<span class="c1"># it will print 0</span>
</pre></div>
...
<span class="c1"># it will print 13</span>
</pre></div>
...
<span class="c1"># it will print straightbrownhair (no spaces)</span>
</pre></div>
...
<span class="n">len1</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">cookie</span><span class="p">)</span> <span class="o">/</span> <span class="mi">2</span> <span class="c1"># 4</span>
<span class="n">len2</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">cookie2</span><span class="p">)</span> <span class="o">*</span> <span class="mi">45</span> <span class="c1">#225</span>
...
<span class="n">votes</span> <span class="o">=</span> <span class="s2">&quot;Chocolate has &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">len1</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; votes&quot;</span> <span class="o">+</span> <span class="s2">&quot; and Rasin has &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">len2</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; votes&quot;</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Chocolate has 4.0 votes and Rasin has 225 votes
</pre>
</div>
</div>
